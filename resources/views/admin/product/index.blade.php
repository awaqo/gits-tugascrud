...
@section('content')
    <div class="container py-16 px-16">
        ...
        <div class="w-full mt-8">
            <a href="{{ route('product.form') }}" class="text-white font-medium bg-blue-500 py-3 px-6 rounded-lg hover:opacity-80 duration-300">+ Tambah Produk</a>
        </div>
        ...
        <div class="text-2xl font-bold mt-5">List Produk</div>
            ...
            <table class="w-full text-sm text-left text-gray-600">
                <thead class="text-xs text-violet-800 uppercase bg-violet-300">
                    <tr class="divide-x">
                        ...
                        <th scope="col" class="w-16 text-center px-3 py-3">
                            Stok
                        </th>
                ...
                <tbody>
                    @if ($products->count() < 1)
                        <tr>
                            <td colspan="7" class="py-4 px-6 text-center text-lg font-semibold">Belum ada kategori</td>
                        </tr>
                    @else
                            ...
                            <tr class="divide-x bg-white border-b hover:bg-gray-100">
                                ...
                                <td class="w-32 px-6 py-4">
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ url('admin/product/' . $item->id . '/show') }}"
                                            class="py-2 px-3 rounded-md text-white bg-blue-500 hover:bg-blue-600"
                                            data-tooltip-target="tooltip-open" data-tooltip-style="light">
                                            <i class="fa-solid fa-arrow-up-right-from-square"></i>
                                        </a>
                                        <a href="{{ url('admin/product/' . $item->id . '/edit') }}" class="py-2 px-3 rounded-md text-white bg-yellow-500 hover:bg-yellow-600" data-tooltip-target="tooltip-edit" data-tooltip-style="light">
        ...
        <div id="tooltip-open" role="tooltip"
